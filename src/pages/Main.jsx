  ...
  const [lists, setLists] = useState([
    {
      ...
      entries: [
        ...
        { date: "2025-09-16", taken: true },
        { date: "2025-09-17", taken: true },
        { date: "2025-09-18", taken: false },
        { date: "2025-09-19", taken: false }, // posible día de hoy
        { date: "2025-09-20", taken: false },
      ],
    },
    {
      id: "m2",
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <h1 className="mt-8 text-3xl font-extrabold text-teal-900 mb-6">
